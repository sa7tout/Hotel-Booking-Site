...
<head>
    ...
    <!--Title-->
    <title>About us | VAGO - Hotel, Resort & Accommodation Website Template</title>
                ...
                <div class="container">
                    <div class="about">
                                    ...
                                    <div class="text">
                                        ...
                                        <div class="gallery">
                                            ...
                                            <div class="owl-slider owl-slider-gallery">
                                                ...
                                                <div class="item" style="background-image:url(assets/images/vagoslide3.jpg)"></div>

                                                <!-- === slide item === -->

                                                <div class="item" style="background-image:url(assets/images/vagoslide2.jpg)"></div>


                                                <!-- === slide item === -->

                                                <div class="item" style="background-image:url(assets/images/vagoslide1.jpg)"></div>
                                        ...
                                        <p>
                                            <img src="assets/images/vagoroom-2.jpg" alt="VAGO Hotel - Resort & accommodation" />
                                        </p>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-3">
                                                <article>
                                                    <div class="details details-text">
                                                        <div class="inner">
                                                            <h4 class="title">YOUNESS KASSIDE</h4>
                                            ...
                                            <div class="col-sm-3">
                                                <article>
                                                    <div class="details details-text">
                                                        <div class="inner">
                                                            <h4 class="title">AYA ELMGHARI</h4>
                        ...
                        <div class="blocks blocks-left">
                            ...
                            <div class="image" style="background-image:url(assets/images/vagoroom-3.jpg)">
                        ...
                        <div class="blocks blocks-right">
                            ...
                            <div class="image" style="background-image:url(assets/images/vagoservice-3.jpg)">
                                <img src="assets/images/vagoservice-3.jpg" alt="" />
                            </div>
                        </div>
